...
- **2026-06-18**: `Download` folder (singular, not `Downloads`) on Pixel 9 Pro at `/storage/emulated/0/Download/`. SSH port 8022 managed by Termux `sshd` runit service. ADB (`android-tools`) available via `pkg install`.
